...
import { WithSubnavigation } from "../components/header/HeaderNav";
import SignUpModal from "../components/modal/SignUpModal";
import { useState } from "react";
import Meta from "../components/header/Head";
...
const Home: NextPage = () => {
  ...
  return (
    <div>
          ...
          >
            ...
            >
              <Button
                ...
                px={20}
                py={15}
                fontSize={{ base: "25px", sm: "15px", md: "25px" }}
                _hover={{
                  bg: "green.200",
                }}
              >
      ...
      <Box w="100%" backgroundColor={"teal.50"}>
        <Stack align={"center"}>
          <Image
            src="/games.jpg"
            alt="Vercel Logo"
